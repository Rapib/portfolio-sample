  ...
  render() {
    ...
    return (
      <header id="home" style={{ height: window.innerHeight - 100, display: 'block' }}>
        <a href="https://github.com/Rapib" target="_blank" rel="noreferrer" className="github-corner" aria-label="View source on GitHub">
        ...
        <div className="row aligner" style={{height: '100%'}}>
          <div className="col-md-12">
            <div>
              ...
              {/* <img src="../images/tom.png" alt="tom" width="250" height="250" border="4px solid #ffffff" /> */}
              <br/>
              <h1 className="mb-0">
                {name}
              </h1>
